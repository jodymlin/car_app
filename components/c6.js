...
export default class C6 extends React.Component {
  state = {
    modalVisible: false,
    thing: "N/A",
  };
    ...
    return (
      <View style={styles.container}>
        <Modal style = {styles.container}
          ...
          <View>
            <View>
              <Text style = {styles.ModalText}>Did you change the Transmission fluid today?</Text>
              <TouchableHighlight
                onPress={() => {
        ...
        <TouchableHighlight style={styles.col}
          ...
          <Text style = {styles.contentText}> Transmission Fluid </Text>
        </TouchableHighlight>
      </View>
    );
  }
